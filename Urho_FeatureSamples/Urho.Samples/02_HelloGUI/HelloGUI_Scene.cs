...
namespace Urho.Samples
{
	public partial class HelloGUI : Sample
	{
		...
		private void CreateScene()
		{
			...
			boxText1.SetFont(cache.GetFont("Fonts/BlueHighway.ttf"), 24);
			...
			boxText2.SetFont(cache.GetFont("Fonts/BlueHighway.ttf"), 24);
			...
			ninjaText.SetFont(cache.GetFont("Fonts/BlueHighway.ttf"), 24);
		...
		private void _UpdateScene(float timeStep)
		{
